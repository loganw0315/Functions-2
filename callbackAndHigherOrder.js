...
// CODE HERE 
const contains = (arr, string, callback) => {
...
const each = (names, callback) => names.forEach((elem, i) => callback([i], elem))
/*
...
// CODE HERE
each (names, (item, index) => console.log(`The item at index ${item} is ${index}`))
